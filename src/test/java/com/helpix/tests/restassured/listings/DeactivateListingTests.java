...
public class DeactivateListingTests extends TestBase {
    ...
    @Test
    public void DeactivateListingPositiveTest() {
        int statusCode = listingHelper.deactivateListing(savedListingId);
    ...
    public void DeleteListingNegativeWithInvalidAccessTokenTest() {
        int statusCode = listingHelper.deactivateListingWithInvalidAccessToken(savedListingId);
    ...
    public void DeleteListingNegativeWithInvalidListingIdTest() {
        int statusCode = listingHelper.deactivateListing(INVALID_LISTING_ID);
