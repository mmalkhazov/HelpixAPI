...
//    We must at first create the Listing and then we can deactivate it
    @BeforeMethod
    ...
    @Test
    public void DeactivateListingTest(){
        ListingResponseDto responseDto = given()
                .contentType(ContentType.JSON)
                .header("Authorization", "Bearer " + getSavedLocalAccessToken())
                .when()
        ...
        Assert.assertFalse(responseDto.isActive(),  "The Listing is not deactivated!");
